...
parser.add_argument('--input_size', default=9, type=int, help='|输入的长度|')
parser.add_argument('--output_size', default=1, type=int, help='|输出的长度|')
parser.add_argument('--label_index', default=[3], type=list, help='|标签为data.y[:,label_index]|')
